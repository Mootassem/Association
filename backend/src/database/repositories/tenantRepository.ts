...
class TenantRepository {
  ...
  static async destroy(id, options: IRepositoryOptions) {
    ...
    await Category(options.database).deleteMany({ tenant: id }, options);

    await Subcategories(options.database).deleteMany({ tenant: id }, options);

    await ChieldCategories(options.database).deleteMany({ tenant: id }, options);

    await Taxes(options.database).deleteMany({ tenant: id }, options);

    await Brands(options.database).deleteMany({ tenant: id }, options);

    await Edit(options.database).deleteMany({ tenant: id }, options);

    await CampaignItems(options.database).deleteMany({ tenant: id }, options);

    await Gallery(options.database).deleteMany({ tenant: id }, options);

    await Product(options.database).deleteMany({ tenant: id }, options);

    await Shippingservice(options.database).deleteMany({ tenant: id }, options);

    await Coupons(options.database).deleteMany({ tenant: id }, options);

    await Transaction(options.database).deleteMany({ tenant: id }, options);

    await TrackOrder(options.database).deleteMany({ tenant: id }, options);

    await Order(options.database).deleteMany({ tenant: id }, options);

    await State(options.database).deleteMany({ tenant: id }, options);

    await AttributeOptions(options.database).deleteMany({ tenant: id }, options);

    await Cart(options.database).deleteMany({ tenant: id }, options);

    await Paymentsettings(options.database).deleteMany({ tenant: id }, options);

    await Review(options.database).deleteMany({ tenant: id }, options);
